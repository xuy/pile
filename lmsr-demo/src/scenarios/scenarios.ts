...
import { createMarket, LMSRMarket } from '../core/lmsr.js';
...
export const scenarios: Scenario[] = [
  ...
  },
  {
    ...
    market: createMarket(
      ...
      50,
      [20, 15, 10]  // Start with some existing trades
    ),
    initialCash: 200,
    guidance: [
  ...
  },
  {
    ...
    market: createMarket(
      ['Team A', 'Team B', 'Team C', 'Team D', 'Team E', 'Other'],
      20
    ),
    initialCash: 150,
    guidance: [
  ...
  },
  {
    ...
    market: createMarket(
      ['Heads', 'Tails'],
      5  // Low liquidity - very sensitive
    ),
    initialCash: 100,
    guidance: [
  ...
  },
  {
    ...
    market: createMarket(
      ['Blue', 'Red', 'Green'],
      15,
      [5, 15, 3]  // Intentionally mispriced - Red is overvalued
    ),
    initialCash: 200,
    guidance: [
